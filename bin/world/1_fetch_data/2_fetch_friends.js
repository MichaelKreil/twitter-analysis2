...
var fileIn  = resolve(__dirname, '../../../data/world/1_ids/ids_selected_'+config.activityMinimumName+'_2.tsv.xz');
var fileOut = resolve(__dirname, '../../../data/world/1_ids/ids_selected_'+config.activityMinimumName+'_3.tsv.xz');
