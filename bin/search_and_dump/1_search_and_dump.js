...
var queries = [
	...
	{name: 'media3_20min',                  query: {q:'url:20min.ch,@20min'.expandMedia()}},
	{name: 'media3_achgut',                 query: {q:'url:achgut.com,@Achgut_com'.expandMedia()}},
	...
	{name: 'media3_blick_ch',               query: {q:'url:blick.ch,@Blickch'.expandMedia()}},
	{name: 'media3_br24',                   query: {q:'url:br24.de,@BR24'.expandMedia()}},
	{name: 'media3_cicero',                 query: {q:'url:cicero.de,@cicero_online'.expandMedia()}},
	{name: 'media3_de_kurier',              query: {q:'url:deutschland?kurier.org,@de_kurier'.expandMedia()}},
	{name: 'media3_derstandard',            query: {q:'url:derstandard.at,@derStandardat,@PolitikStandard'.expandMedia()}},
	{name: 'media3_dpa',                    query: {q:'@dpa'.expandMedia()}},
	{name: 'media3_dwn',                    query: {q:'url:deutsche?wirtschafts?nachrichten.de'.expandMedia()}},
	{name: 'media3_epochtimes',             query: {q:'url:epochtimes.de,@EpochTimesDE'.expandMedia()}},
	...
	{name: 'media3_focus',                  query: {q:'url:focus.de,@focusauto,@focusdigital,@focusonline,@focuspolitik,@focusreise,@focuswissen'.expandMedia()}},
	{name: 'media3_freitag',                query: {q:'url:freitag.de,@derfreitag'.expandMedia()}},
	{name: 'media3_huffingtonpost_de',      query: {q:'url:huffingtonpost.de,@HuffPostDE'.expandMedia()}},
	{name: 'media3_jouwatch',               query: {q:'url:journalistenwatch.com,@jouwatch'.expandMedia()}},
	{name: 'media3_junge_freiheit',         query: {q:'url:jungefreiheit.de,@Junge_Freiheit'.expandMedia()}},
	{name: 'media3_jungewelt',              query: {q:'url:jungewelt.de,@jungewelt'.expandMedia()}},
	{name: 'media3_kenfm',                  query: {q:'url:kenfm.de'.expandMedia()}},
	{name: 'media3_krone_at',               query: {q:'url:krone.at,@krone_at'.expandMedia()}},
	{name: 'media3_mdraktuell',             query: {q:'url:mdr.de,@MDRAktuell'.expandMedia()}},
	{name: 'media3_neues_deutschland',      query: {q:'url:neues?deutschland.de,@ndaktuell'.expandMedia()}},
	{name: 'media3_ntv',                    query: {q:'url:n?tv.de,@ntv_EIL,@ntvde,@ntvde_auto,@ntvde_Politik,@ntvde_politik,@ntvde_sport'.expandMedia()}},
	{name: 'media3_nzz',                    query: {q:'url:nzz.ch,@nzz,@NZZde,@NZZMeinung,@NZZSchweiz,@NZZWissen,@NZZStorytelling,@NZZzuerich,@NZZfeuilleton,@NZZAusland,@nzzwirtschaft,@NZZSport'.expandMedia()}},
	{name: 'media3_pi_news',                query: {q:'url:pi?news.net,@p_i'.expandMedia()}},
	{name: 'media3_politikversagen',        query: {q:'url:politikversagen.net,@staatsversagen'.expandMedia()}},
	{name: 'media3_rbb',                    query: {q:'url:rbb?online.de,rbb24.de,@rbbabendschau'.expandMedia()}},
	{name: 'media3_rt_deutsch',             query: {q:'url:deutsch.rt.com,@RT_Deutsch'.expandMedia()}},
	...
	{name: 'media3_sputniknews',            query: {q:'url:de.sputniknews.com'.expandMedia()}},
	{name: 'media3_stern',                  query: {q:'url:stern.de,@sternde'.expandMedia()}},
	...
	{name: 'media3_swraktuell',             query: {q:'url:SWRAktuell.de,@SWRAktuell'.expandMedia()}},
	{name: 'media3_t_online',               query: {q:'url:www.t?online.de,@tonline_news'.expandMedia()}},
	{name: 'media3_tagesschau',             query: {q:'url:tagesschau.de,@tagesschau'.expandMedia()}},
	{name: 'media3_tagesspiegel',           query: {q:'url:tagesspiegel.de,@Tagesspiegel,@TspBerlin,@TspCausa,@TspLeute,@TSPSonntag,@tspsport'.expandMedia()}},
	{name: 'media3_taz',                    query: {q:'url:taz.de,@tazgezwitscher,@taz_news'.expandMedia()}},
	{name: 'media3_theeuropean',            query: {q:'url:theeuropean.de,@theeuropean'.expandMedia()}},
	{name: 'media3_tichyseinblick',         query: {q:'url:tichyseinblick.de,@TichysEinblick'.expandMedia()}},
	{name: 'media3_unzensuriert_at',        query: {q:'url:unzensuriert.at,@unzensuriert'.expandMedia()}},
	{name: 'media3_unzensuriert_de',        query: {q:'url:unzensuriert.de'.expandMedia()}},
	{name: 'media3_voiceofEurope',          query: {q:'url:voiceofeurope.com,@VoiceofEurope'.expandMedia()}},
	{name: 'media3_waz',                    query: {q:'url:waz.de,@WAZ_Redaktion'.expandMedia()}},
	{name: 'media3_welt',                   query: {q:'url:welt.de,@WELT,@WELT_EIL,@WELT_Wissen,@WELT_Webwelt,@WELT_Kultur,@WELT_Sport,@WELT_Medien,@WELT_Panorama,@WELT_Geld,@WELT_Economy,@WELT_Politik'.expandMedia()}},
	{name: 'media3_zdf',                    query: {q:'url:zdf.de,@ZDF'.expandMedia()}},
	{name: 'media3_zdf_heute',              query: {q:'url:heute.de,@heutejournal,@heuteplus'.expandMedia()}},
	{name: 'media3_zeit',                   query: {q:'url:zeit.de,@zeitonline,@zeitonline_dig,@zeitonline_ent,@zeitonline_fam,@zeitonline_kul,@zeitonline_live,@zeitonline_pol,@zeitonline_vid,@zeitonline_wir,@zeitonline_wis,@zeitonlinesport'.expandMedia()}},
	...
	{name: 'muslime',                       query: {q:'islam,moslem,moslems,moslimisch,moslimische,moslimischer,moslimischen,muslim,muslima,muslime,muslimen,muslimin,muslimisch,muslimische,muslimischen,muslimischer'.toOR()}},
	...
	{name: 'omaumweltsau',                  query: {q:'omaumweltsau,umweltsau,huehnerstallgate,omanazisau,wdrlich,nazisau,umweltsauoma'.toOR()}},
	{name: 'omaumweltsau2',                 query: {q:'omagate,umweltsaugate'.toOR()}},
