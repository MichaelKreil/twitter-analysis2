...
var queries = [
	...
	{name: 'baerbock',                      query: {q:'@ABaerbock,Baerbock,Bärbock,#Baerbock,#BaerbockRuecktritt,#baerbockRuecktrittSofort'.expand()}},
	...
	{name: 'brazilelections_3',             query: {q:'#Bolsonaroreeleitoem2022,imbrochável,#Broxonaro'.expand()}},
	...
	{name: 'impfen2',                       query: {q:'ichbereuedieimpfung'}},
	...
	{name: 'media4_de_kurier2',             query: {q:'url:deutschlandkurier.de,@deu_kurier'.expand()}},
	...
	{name: 'media4_dwn2',                   query: {q:'url:deutsche-wirtschafts-nachrichten.de'.expand()}},
	...
	{name: 'media4_neues_deutschland2',     query: {q:'url:nd-aktuell.de,@ndaktuell'.expand()}},
   ...
   {name: 'media4_rbb2',                   query: {q:'url:rbb24.de,rbb24.de,@rbbabendschau'.expand()}},
	...
	{name: 'media4_swr',                    query: {q:'url:www.swr.de,@DASDING,@Kaffee_oder_Tee,@SWR2,@SWR2Archivradio,@swr2wissen,@swr3,@SWRAktuellBW,@SWRAktuellRP,@SWRBildung,@SWRsport,@SWRSymphonie,@Umweltnews,@Verbrauchernews,@VSSpass'.expand()}},
	...
	{name: 'media4_t_online2',              query: {q:'url:t?online.de,@tonline_news,@tonline'.expand()}},
	...
	{name: 'pedohitler',                    query: {q:'pedohitler,#pedohitler'}},
	...
	{name: 'propaganda',                    query: {q:'propaganda'}},
	...
	{name: 'shooting',                      query: {q:'shooting'.expand()}},
