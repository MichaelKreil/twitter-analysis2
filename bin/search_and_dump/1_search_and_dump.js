...
var queries = [
	...
	{name: 'media_20min',                   query: {q:'url:20min.ch,@20min'.expandMedia()}},
	{name: 'media_bild',                    query: {q:'url:bild.de,@BILD,@BILD_Auto,@BILD_Bayern,@BILD_Berlin,@BILD_Blaulicht,@BILD_Bochum,@BILD_Bremen,@BILD_Chemnitz,@BILD_Digital,@BILD_Dresden,@BILD_Frankfurt,@bild_freiburg,@bild_fuerth,@BILD_Hamburg,@BILD_Hannover,@bild_ingolstadt,@BILD_kaempft,@BILD_Koeln,@BILD_Lautern,@BILD_Leipzig,@BILD_Lifestyle,@BILD_Muenchen,@BILD_News,@BILD_Nuernberg,@BILD_Politik,@BILD_Promis,@BILD_Reporter,@BILD_Ruhrgebiet,@BILD_Saarland,@BILD_Sport,@BILD_Stuttgart,@BILD_TopNews,@BILD_Wolfsburg,@BILDamSONNTAG,@BILDDuesseldorf,@BILDhilft,@BILDthueringen'.expandMedia()}},
	{name: 'media_blick_ch',                query: {q:'url:blick.ch,@Blickch'.expandMedia()}},
	{name: 'media_br24',                    query: {q:'url:br24.de,@BR24'.expandMedia()}},
	{name: 'media_derstandard',             query: {q:'url:derstandard.at,@derStandardat,@PolitikStandard'.expandMedia()}},
	{name: 'media_dpa',                     query: {q:'url:@dpa'.expandMedia()}},
	{name: 'media_epochtimes',              query: {q:'url:epochtimes.de,@EpochTimesDE'.expandMedia()}},
	{name: 'media_faz',                     query: {q:'url:faz.net,@FAZ_Auto,@FAZ_BerufChance,@FAZ_Buch,@FAZ_Eil,@FAZ_Feuilleton,@FAZ_Finanzen,@FAZ_Hanz,@FAZ_Immobilien,@FAZ_Kunstmarkt,@FAZ_Literatur,@FAZ_NET,@FAZ_Politik,@faz_Redaktion,@FAZ_Reise,@FAZ_RheinMain,@FAZ_Sport,@FAZ_Technik,@FAZ_Vermischtes,@FAZ_Wirtschaft,@FAZ_Wissen,@FAZBoersenspiel,@faznet'.expandMedia()}},
	{name: 'media_focus',                   query: {q:'url:focus.de,@focusauto,@focusdigital,@focusonline,@focuspolitik,@focusreise,@focuswissen'.expandMedia()}},
	{name: 'media_freitag',                 query: {q:'url:freitag.de,@derfreitag'.expandMedia()}},
	{name: 'media_huffingtonpost_de',       query: {q:'url:huffingtonpost.de,@HuffPostDE'.expandMedia()}},
	{name: 'media_junge_freiheit',          query: {q:'url:jungefreiheit.de,@Junge_Freiheit'.expandMedia()}},
	{name: 'media_jungewelt',               query: {q:'url:jungewelt.de,@jungewelt'.expandMedia()}},
	{name: 'media_krone_at',                query: {q:'url:krone.at,@krone_at'.expandMedia()}},
	{name: 'media_mdraktuell',              query: {q:'url:mdr.de,@MDRAktuell'.expandMedia()}},
	{name: 'media_neues_deutschland',       query: {q:'url:neues-deutschland.de,@ndaktuell'.expandMedia()}},
	{name: 'media_ntv',                     query: {q:'url:n-tv.de,@ntv_EIL,@ntvde,@ntvde_auto,@ntvde_Politik,@ntvde_politik,@ntvde_sport'.expandMedia()}},
	{name: 'media_nzz',                     query: {q:'url:nzz.ch,@nzz,@NZZde,@NZZMeinung,@NZZSchweiz,@NZZWissen,@NZZStorytelling,@NZZzuerich,@NZZfeuilleton,@NZZAusland,@nzzwirtschaft,@NZZSport'.expandMedia()}},
	{name: 'media_pi_news',                 query: {q:'url:pi-news.net,@p_i'.expandMedia()}},
	{name: 'media_rbb',                     query: {q:'url:rbb-online.de,rbb24.de,@rbbabendschau'.expandMedia()}},
	{name: 'media_rt_deutsch',              query: {q:'url:deutsch.rt.com,@RT_Deutsch'.expandMedia()}},
	{name: 'media_smopo',                   query: {q:'url:smopo.ch'}},
	{name: 'media_spiegel',                 query: {q:'url:spiegel.de,@SPIEGEL_24,@SPIEGEL_alles,@SPIEGEL_Auto,@SPIEGEL_Data,@SPIEGEL_EIL,@SPIEGEL_English,@SPIEGEL_Gesund,@SPIEGEL_kolumne,@SPIEGEL_Kultur,@SPIEGEL_live,@SPIEGEL_Netz,@SPIEGEL_Pano,@SPIEGEL_Politik,@SPIEGEL_Reise,@SPIEGEL_Rezens,@SPIEGEL_SPAM,@SPIEGEL_Sport,@SPIEGEL_Top,@SPIEGEL_Video,@SPIEGEL_Wirtsch,@SPIEGEL_Wissen,@SPIEGELDAILY,@SPIEGELONLINE,@SPIEGELTV,@SPIEGELzwischen'.expandMedia()}},
	{name: 'media_stern',                   query: {q:'url:stern.de,@sternde'.expandMedia()}},
	{name: 'media_sueddeutsche',            query: {q:'url:sueddeutsche.de,@SZ,@SZ_WolfratsToel,@SZ_Starnberg,@SZ_Ebersberg,@SZ_Dachau,@SZ_Freising,@SZ_FFB,@SZ_Erding,@SZ_Bildung,@SZ_Medien,@SZ_Eilmeldungen,@SZ_Reise,@SZ_Gesundheit,@SZ_Wissen,@SZ_Digital,@SZ-Digital,@SZ_Auto,@SZ_Bayern,@SZ_Muenchen,@SZ_Karriere,@SZ_Gesellschaft,@SZ_Sport,@SZ_Kultur,@SZ_Geld,@SZ_Wirtschaft,@SZ_Politik,@szmagazin,@SZ_TopNews'.expandMedia()}},
	{name: 'media_swraktuell',              query: {q:'url:SWRAktuell.de,@SWRAktuell'.expandMedia()}},
	{name: 'media_t_online',                query: {q:'url:www.t-online.de,@tonline_news'.expandMedia()}},
	{name: 'media_tagesschau',              query: {q:'url:tagesschau.de,@tagesschau'.expandMedia()}},
	{name: 'media_tagesspiegel',            query: {q:'url:tagesspiegel.de,@Tagesspiegel,@TspBerlin,@TspCausa,@TspLeute,@TSPSonntag,@tspsport'.expandMedia()}},
	{name: 'media_taz',                     query: {q:'url:taz.de,@tazgezwitscher,@taz_news'.expandMedia()}},
	{name: 'media_tichyseinblick',          query: {q:'url:tichyseinblick.de,@TichysEinblick'.expandMedia()}},
	{name: 'media_waz',                     query: {q:'url:waz.de,@WAZ_Redaktion'.expandMedia()}},
	{name: 'media_welt',                    query: {q:'url:welt.de,@WELT,@WELT_EIL,@WELT_Wissen,@WELT_Webwelt,@WELT_Kultur,@WELT_Sport,@WELT_Medien,@WELT_Panorama,@WELT_Geld,@WELT_Economy,@WELT_Politik'.expandMedia()}},
	{name: 'media_zdf',                     query: {q:'url:zdf.de,@ZDF'.expandMedia()}},
	{name: 'media_zdf_heute',               query: {q:'url:heute.de,@heutejournal,@heuteplus'.expandMedia()}},
	{name: 'media_zeit',                    query: {q:'url:zeit.de,@zeitonline,@zeitonline_dig,@zeitonline_ent,@zeitonline_fam,@zeitonline_kul,@zeitonline_live,@zeitonline_pol,@zeitonline_vid,@zeitonline_wir,@zeitonline_wis,@zeitonlinesport'.expandMedia()}},
